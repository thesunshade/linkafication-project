...
function decorate() {
  ...
  messageArea.innerHTML = `Decorated in ${(end - start) / 1000} seconds! Check console`;
...
listButton.addEventListener("click", makeLists);

function doTheDecorating() {
...
linkButton.addEventListener("click", () => doTheDecorating());
